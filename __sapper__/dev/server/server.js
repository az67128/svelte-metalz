...
const GenreDialog = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ $showGenreDialog ? `<div class="genreSelect svelte-198kik7">
	    <header class="svelte-198kik7">
	      ${validate_component(IconButton, 'IconButton').$$render($$result, { onClick: () => showGenreDialog.set(false) }, {}, {
		default: () => `
	        ${validate_component(LeftArrowIcon, 'LeftArrowIcon').$$render($$result, {}, {}, {})}
	      `
	})}
