...
const css = {
	code: ".button.svelte-9l5ek4{position:relative;background:none;cursor:pointer;border:none;padding:0;margin:0;height:24px;color:inherit}@media(any-hover: none){.button.svelte-9l5ek4{outline:none}}",
	map: "{\"version\":3,\"file\":\"IconButton.svelte\",\"sources\":[\"IconButton.svelte\"],\"sourcesContent\":[\"<script>\\n  export let onClick = () => {};\\n</script>\\n\\n<style>\\n  .button {\\n    position: relative;\\n    background: none;\\n    cursor: pointer;\\n    border: none;\\n    padding: 0;\\n    margin: 0;\\n    height: 24px;\\n    color: inherit;\\n  }\\n  @media (any-hover: none) {\\n    .button {\\n      outline: none;\\n    }\\n  }\\n</style>\\n\\n<button on:click={onClick} class=\\\"button\\\">\\n\\n  <slot />\\n\\n</button>\\n\"],\"names\":[],\"mappings\":\"AAKE,OAAO,cAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,OAAO,AAChB,CAAC,AACD,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACxB,OAAO,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACf,CAAC,AACH,CAAC\"}"
};
...
const IconButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<button class="button svelte-9l5ek4">
...
const Main = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  afterUpdate(() => {
	...
	return `<main class="main svelte-vpg4i0"${add_attribute("this", container)}>
	  <div class="wrapper svelte-vpg4i0" style="transform: translate(${escape($coords)}px,0px)">
	    ${ $isLoading ? `${validate_component(Loader, 'Loader').$$render($$result, {}, {}, {})}` : `${each($sortedAlbums.slice(0, limit), (album, index) => `${validate_component(Index, 'Album').$$render($$result, { album: album }, {}, {})}
	        ${ (index + 1) % 5 === 0 || index + 1 === limit ? `<span${(v => v == null ? "" : ` index="${escape(index)}"`)(index)} class="intersection svelte-vpg4i0"${add_attribute("this", trigger)}>
	            intersection
	          </span>` : `` }`)}` }
	  </div>
...
const css$9 = {
	code: ".genreSelect.svelte-j43c0x{z-index:2;background:white;position:fixed;top:0px;bottom:0px;width:100%;height:100%;display:flex;flex-direction:column}header.svelte-j43c0x{padding:1rem;box-shadow:0px 1px 3px 0px rgba(0, 0, 0, 0.2),\n      0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 2px 1px -1px rgba(0, 0, 0, 0.12);z-index:1;display:flex;justify-content:space-between;align-items:center;font-size:1.2rem;font-weight:bold}main.svelte-j43c0x{flex-grow:1;overflow:auto;padding:1rem;background:#f5f5f5}.button.svelte-j43c0x{background:none;outline:none;padding:0;margin:0;border:none;cursor:pointer}.selected.svelte-j43c0x{color:#b2102f}.genre.svelte-j43c0x{margin-bottom:0.5rem;font-size:1.1rem;display:block}.genre.svelte-j43c0x:hover{color:#b2102f}",
	map: "{\"version\":3,\"file\":\"GenreDialog.svelte\",\"sources\":[\"GenreDialog.svelte\"],\"sourcesContent\":[\"<script>\\n  import genres from \\\"../utils/genres\\\";\\n  import IconButton from \\\"./IconButton.svelte\\\";\\n  import LeftArrowIcon from \\\"../assets/LeftArrowIcon.svelte\\\";\\n  import { showGenreDialog, selectedGenres } from \\\"../stores/albums\\\";\\n  import translate from \\\"../utils/translation\\\";\\n  import { fly } from \\\"svelte/transition\\\";\\n  const close = () => {\\n    showGenreDialog.set(false);\\n    selectedGenres.reset();\\n  };\\n</script>\\n\\n<style>\\n  .genreSelect {\\n    z-index: 2;\\n    background: white;\\n    position: fixed;\\n    top: 0px;\\n    bottom: 0px;\\n    width: 100%;\\n    height: 100%;\\n    display: flex;\\n    flex-direction: column;\\n  }\\n  header {\\n    padding: 1rem;\\n    box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.2),\\n      0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 2px 1px -1px rgba(0, 0, 0, 0.12);\\n    z-index: 1;\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n    font-size: 1.2rem;\\n    font-weight: bold;\\n  }\\n  main {\\n    flex-grow: 1;\\n    overflow: auto;\\n    padding: 1rem;\\n    background: #f5f5f5;\\n  }\\n\\n  .button {\\n    background: none;\\n    outline: none;\\n    padding: 0;\\n    margin: 0;\\n    border: none;\\n    cursor: pointer;\\n  }\\n  .selected {\\n    color: #b2102f;\\n  }\\n  .genre {\\n    margin-bottom: 0.5rem;\\n    font-size: 1.1rem;\\n    display: block;\\n  }\\n  .genre:hover {\\n    color: #b2102f;\\n  }\\n</style>\\n\\n{#if $showGenreDialog}\\n  <div\\n    class=\\\"genreSelect\\\"\\n    transition:fly={{ x: -window.innerWidth, duration: 300 }}>\\n    <header>\\n      <IconButton onClick={() => showGenreDialog.set(false)}>\\n        <LeftArrowIcon />\\n      </IconButton>\\n      <div>{translate('genreSelectTitle')}</div>\\n      <button class=\\\"button\\\" on:click={close}>RESET</button>\\n    </header>\\n    <main>\\n      {#each genres as genre, index (genre)}\\n        <button\\n          class=\\\"genre button\\\"\\n          class:selected={$selectedGenres.some(item => item === genre)}\\n          on:click={() => selectedGenres.toggle(genre)}>\\n          {genre}\\n        </button>\\n      {/each}\\n    </main>\\n  </div>\\n{/if}\\n\"],\"names\":[],\"mappings\":\"AAcE,YAAY,cAAC,CAAC,AACZ,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,KAAK,CACjB,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,GAAG,CACR,MAAM,CAAE,GAAG,CACX,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,AACxB,CAAC,AACD,MAAM,cAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC;MAC7C,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAC3E,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,AACnB,CAAC,AACD,IAAI,cAAC,CAAC,AACJ,SAAS,CAAE,CAAC,CACZ,QAAQ,CAAE,IAAI,CACd,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,OAAO,cAAC,CAAC,AACP,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,OAAO,AACjB,CAAC,AACD,SAAS,cAAC,CAAC,AACT,KAAK,CAAE,OAAO,AAChB,CAAC,AACD,MAAM,cAAC,CAAC,AACN,aAAa,CAAE,MAAM,CACrB,SAAS,CAAE,MAAM,CACjB,OAAO,CAAE,KAAK,AAChB,CAAC,AACD,oBAAM,MAAM,AAAC,CAAC,AACZ,KAAK,CAAE,OAAO,AAChB,CAAC\"}"
};
...
const GenreDialog = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ $showGenreDialog ? `<div class="genreSelect svelte-j43c0x">
	    <header class="svelte-j43c0x">
		...
		default: () => `
	      ...
	      <button class="button svelte-j43c0x">RESET</button>
	    </header>
	    <main class="svelte-j43c0x">
	      ${each(genres, (genre, index) => `<button class="${[`genre button svelte-j43c0x`, $selectedGenres.some(item => item === genre) ? "selected" : ""].join(' ').trim() }">
	          ${escape(genre)}
	        </button>`)}
	    </main>
	  </div>` : `` }`;
