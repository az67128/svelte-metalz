...
const GuitarIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { fill = "black", width = "24" } = $$props;

	if ($$props.fill === void 0 && $$bindings.fill && fill !== void 0) $$bindings.fill(fill);
	if ($$props.width === void 0 && $$bindings.width && width !== void 0) $$bindings.width(width);

	return `<svg${(v => v == null ? "" : ` width="${escape(width)}"`)(width)}${(v => v == null ? "" : ` fill="${escape(fill)}"`)(fill)} viewBox="0 0 481.677 481.678">
	  <g>
	    <g>
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const openGenreDialog = () => {
	...
	return `<footer class="svelte-1vyyi6d">
	  ${validate_component(IconButton, 'IconButton').$$render($$result, { onClick: openGenreDialog }, {}, {
		default: () => `
...
const css$3 = {
	code: ".content.svelte-xiz3x7{display:flex}.albumInfo.svelte-xiz3x7{padding:0.5rem;display:flex;flex-direction:column;flex-flow:1}.cover.svelte-xiz3x7{margin:0.5rem;width:88px;height:88px;box-shadow:0px 1px 3px 0px rgba(0, 0, 0, 0.2),\n      0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 2px 1px -1px rgba(0, 0, 0, 0.12);background:rgba(0, 0, 0, 0.2);display:flex;align-items:center;justify-content:center}.cover.svelte-xiz3x7 img.svelte-xiz3x7{width:88px;height:88px;cursor:pointer}.albumTitle.svelte-xiz3x7{font-size:1.2rem;font-weight:bold;flex-grow:1}",
	map: "{\"version\":3,\"file\":\"Content.svelte\",\"sources\":[\"Content.svelte\"],\"sourcesContent\":[\"<script>\\n  import { spiritOfMetalUrl } from \\\"../../config\\\";\\n  import { coverPreviewSrc } from \\\"../../stores/albums\\\";\\n  import GuitarIcon from \\\"../../assets/GuitarIcon.svelte\\\";\\n  export let cover_url;\\n  export let title;\\n  export let author;\\n  export let genre;\\n  let src = `${spiritOfMetalUrl}${cover_url}`;\\n  const viewCover = () => {\\n    coverPreviewSrc.set(src);\\n  };\\n\\n  // 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='\\n</script>\\n\\n<style>\\n  .content {\\n    display: flex;\\n  }\\n\\n  .albumInfo {\\n    padding: 0.5rem;\\n    display: flex;\\n    flex-direction: column;\\n    flex-flow: 1;\\n  }\\n  .cover {\\n    margin: 0.5rem;\\n    width: 88px;\\n    height: 88px;\\n    box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.2),\\n      0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 2px 1px -1px rgba(0, 0, 0, 0.12);\\n    background: rgba(0, 0, 0, 0.2);\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n  }\\n  .cover img {\\n    width: 88px;\\n    height: 88px;\\n    cursor: pointer;\\n  }\\n  .albumTitle {\\n    font-size: 1.2rem;\\n    font-weight: bold;\\n    flex-grow: 1;\\n  }\\n</style>\\n\\n<div class=\\\"content\\\">\\n  <div class=\\\"cover\\\" on:click={viewCover}>\\n    {#if src}\\n      <img {src} alt=\\\"album-cover\\\" on:error={() => (src = null)} />\\n    {:else}\\n      <GuitarIcon width=\\\"40\\\" />\\n    {/if}\\n  </div>\\n  <div class=\\\"albumInfo\\\">\\n    <div class=\\\"albumTitle\\\">{author}</div>\\n    <div>{title}</div>\\n    <div>{genre}</div>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAiBE,QAAQ,cAAC,CAAC,AACR,OAAO,CAAE,IAAI,AACf,CAAC,AAED,UAAU,cAAC,CAAC,AACV,OAAO,CAAE,MAAM,CACf,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,SAAS,CAAE,CAAC,AACd,CAAC,AACD,MAAM,cAAC,CAAC,AACN,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC;MAC7C,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAC3E,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC9B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,AACzB,CAAC,AACD,oBAAM,CAAC,GAAG,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,OAAO,AACjB,CAAC,AACD,WAAW,cAAC,CAAC,AACX,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,CAAC,AACd,CAAC\"}"
};
...
const Content = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  // 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='
	...
	return `<div class="content svelte-xiz3x7">
	  <div class="cover svelte-xiz3x7">
	    ${ src ? `<img${(v => v == null ? "" : ` src="${escape(src)}"`)(src)} alt="album-cover" class="svelte-xiz3x7">` : `${validate_component(GuitarIcon, 'GuitarIcon').$$render($$result, { width: "40" }, {}, {})}` }
	  </div>
	  <div class="albumInfo svelte-xiz3x7">
	    <div class="albumTitle svelte-xiz3x7">${escape(author)}</div>
...
/* src/components/NoAlbums.svelte generated by Svelte v3.6.7 */

const css$7 = {
	code: ".noAlbums.svelte-b37s0r{text-align:center;flex-grow:1;padding:1rem;font-size:1.5rem}",
	map: "{\"version\":3,\"file\":\"NoAlbums.svelte\",\"sources\":[\"NoAlbums.svelte\"],\"sourcesContent\":[\"<script>\\n  import translate from \\\"../utils/translation\\\";\\n</script>\\n\\n<style>\\n  .noAlbums {\\n    text-align: center;\\n    flex-grow: 1;\\n    padding: 1rem;\\n    font-size: 1.5rem;\\n  }\\n</style>\\n\\n<div class=\\\"noAlbums\\\">{translate('noAlbums')}</div>\\n\"],\"names\":[],\"mappings\":\"AAKE,SAAS,cAAC,CAAC,AACT,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,MAAM,AACnB,CAAC\"}"
};

const NoAlbums = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$7);

	return `<div class="noAlbums svelte-b37s0r">${escape(translate('noAlbums'))}</div>`;
});
  ...
  afterUpdate(() => {
	...
	return `<main class="main svelte-dkc0if"${add_attribute("this", container)}>
	  <div class="wrapper svelte-dkc0if" style="transform: translate(${escape($coords)}px,0px)">
	    ${ $isLoading ? `${validate_component(Loader, 'Loader').$$render($$result, {}, {}, {})}` : `${ $sortedAlbums.length === 0 ? `${validate_component(NoAlbums, 'NoAlbums').$$render($$result, {}, {}, {})}` : `` }
	      ${each($sortedAlbums.slice(0, limit), (album, index) => `${validate_component(Index, 'Album').$$render($$result, { album: album }, {}, {})}
